...
DOWNLOAD_SERVICE="${WEB_OSINT_DOWNLOAD_SERVICE:-web-osint-candidate-model-downloads.service}"
...
echo "[$(date -Is)] Web OSINT candidate model download progress monitor starting interval=${INTERVAL}s" | tee -a "$PROGRESS_LOG"
log_progress
